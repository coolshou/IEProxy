...
namespace IEProxy
{
    public class WinInetInterop
    {
        #region Private Constructor
        private WinInetInterop()
        {

        }
        #endregion

        #region InetCPL P/Invoke Defines
        [DllImport("inetcpl.cpl", SetLastError = true)]
        private static extern int LaunchInternetControlPanel(IntPtr hWnd);
        #endregion

        #region WinInet P/Invoke Defines
        ...
        //    ref int lpdwBufferLength	//size of lpBuffer, in bytes.
        //);
        ...
        private struct INTERNET_PER_CONNECTION_OPTION_LIST
        {
            ...
            public INTERNET_PER_CONNECTION_OPTION[] options;
        }
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Auto)]
        ...
        private struct InternetPerConnectionOption
        {
            ...
            static InternetPerConnectionOption()
            {
                InternetPerConnectionOption.Size = Marshal.SizeOf(typeof(InternetPerConnectionOption));
            }
        ...
        {
            INTERNET_PER_CONNECTION_FLAGS = 1, // Sets or retrieves the connection type. The Value member will contain one or more of the values from PerConnectionFlags 
            INTERNET_PER_CONNECTION_PROXY_SERVER = 2, // Sets or retrieves a string containing the proxy servers.  
            INTERNET_PER_CONNECTION_PROXY_BYPASS = 3, // Sets or retrieves a string containing the URLs that do not use the proxy server.  
            INTERNET_PER_CONNECTION_AUTOCONFIG_URL = 4, // Sets or retrieves a string containing the URL to the automatic configuration script.  
            INTERNET_PER_CONNECTION_AUTODISCOVERY_FLAGS = 5//, // Sets or retrieves the automatic discovery settings. The Value member will contain one or more of the values from PerConnAutoDiscoveryFlags 
        ...
        #region Enable/Disable Internet Proxy Flags
        ...
        #region Check Proxy Flags
        public static bool IsAnyProxy()
        {
            return IsUseProxy() | IsAutoDetectProxy() | IsAutoConfigProxy();
        }

        public static bool IsUseProxy()
        {
            return CheckProxyFlag(PerConnectionFlags.PROXY_TYPE_PROXY);
        }

        public static bool IsAutoDetectProxy()
        {
            return CheckProxyFlag(PerConnectionFlags.PROXY_TYPE_AUTO_DETECT);
        }

        public static bool IsAutoConfigProxy()
        {
            return CheckProxyFlag(PerConnectionFlags.PROXY_TYPE_AUTO_PROXY_URL);
        }
        ...
        #region Get Proxy String Values
        ...
        #region Call InternetSetOption With InternetPerConnOptions
        ...
        #region Call InternetQueryOption With InternetPerConnOptions
        ...
        #region Call InternetSetOption with InternetOptionSettingsChanged
        public static bool InternetOptionSettingsChanged()
        {
            return InternetSetOption(IntPtr.Zero, (int)InternetOption.INTERNET_OPTION_SETTINGS_CHANGED, IntPtr.Zero, 0);
        }
        #endregion

        #region Call InternetSetOption with InternetOptionRefresh
        public static bool InternetOptionRefresh()
        {
            return InternetSetOption(IntPtr.Zero, (int)InternetOption.INTERNET_OPTION_REFRESH, IntPtr.Zero, 0);
        }
        #endregion

        #region Display the Internet Properties Control Panel
